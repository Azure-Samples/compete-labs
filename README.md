...
sudo docker run \
  ...
  --env "HUGGING_FACE_HUB_TOKEN=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" \
  --env "VLLM_API_KEY=Q6QGS5TnR4QthgjghEys_cu8FuW8iuOzFrlaUdDEfvc" \
  -p 8000:8000 \
  --ipc=host \
...
curl -X POST "http://20.81.176.15:8000/v1/completions" \
     ...
     -H "Authorization: Bearer Q6QGS5TnR4QthgjghEys_cu8FuW8iuOzFrlaUdDEfvc" \
     -d '{
          "model": "meta-llama/Meta-Llama-3.1-8B",
